...
<section class="about-section bg-light p-5" >
            <div class="row">
                <div class="col-md-12 col-lg-6 col-sm-12 mt-4">
                    ...
                    <p class="title-para ml-5">The four-star Wired Hotel is a gem of traditional Ethiopian architecture, located in the heart of Addis Ababa on Churchill Avenue. With our prime location, we have been a perfect haven for both tourists and business travelers for over 150 years.</p>
                    <p class="title-para ml-5">We offer 300 comfortably equipped rooms, including two luxurious suites: The Presidential Suite and the Ambassador Suite, each designed to impress even the most discerning guests. Our versatile meeting rooms have hosted family and business gatherings for over 15 years.</p>
                    <p class="title-para ml-5">The Wired Hotel is more than just a building; it’s our dedicated team of professionals. With years of experience and extensive conference facilities, along with top-notch technical and catering support, we are ready to organize your event—from our elegant spaces to a tent in the hotel courtyard, or even at a location of your choice.</p>
                </div>
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title"> Abebe Kebede<br /> <small>Head of marketing at K mart</small> </div>
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title"> Chalew Asmamaw<br /> <small>CEO of ABC</small> </div>
                    <div class="card-subtitle">
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title"> Saron Abate<br /> <small>Resident Dj at Addis</small> </div>
                    <div class="card-subtitle">

  ...
  <section class="white-section container">
        ...
        <div class="row featurette">
          <div class="col-md-7 p-5 mt-4">
            ...
            <p class="lead">Ten distinct dining destinations offering Ethiopian and international cuisine, along with some of the world's most acclaimed and prized beverages.</p>
          </div>
          <div class="col-md-5">
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2 p-5 mt-4">
            ...
            <p class="lead">With 300 rooms, 78 elegantly appointed service apartments, and 16 luxurious suites that embody Ethiopian elegance and charm.</p>
          </div>

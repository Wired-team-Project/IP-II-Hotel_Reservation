...
<footer class="text-center text-lg-start bg-dark text-white">
    ...
    >
      ...
      <div>
        ...
        <a href="https://twitter.com/" class="ml-4 text-reset">
          <i class="fab fa-twitter"></i>
        </a>

        <a href="https://instagram.com/" class="ml-4 text-reset">
          <i class="fab fa-instagram"></i>
        </a>
        <a href="https://www.linkedin.com/in/" class="ml-4 text-reset">
          <i class="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/" class="ml-4 text-reset">

...
if(!isset($_SESSION['loggedUserId'])) {
 ...
 if (!isset($_POST['roomTypeId'])) {
    header("Location: room.php?error=Invalid access");
    exit;
}
...
<div class="container">
    <div class="row align-items-center my-5">
        ...
        <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
            <h1>Book a Room</h1>
            <p class="font-italic text-muted mb-0">Information provided below will be used to book a room in to your Wired Hotel account.</p>
            ...
            <form action="client_functions.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    ...
                    <div class="input-group ">
                        ...
                        <input type="email" class="form-control bg-white border-left-0 border-md" name="email" value="<?= $user['Email'] ?>" readonly>
                    </div>
                    </div>
                    ...
                    <div class="input-group ">
                        ...
                        <input id="contactno" type="tel" class="form-control bg-white border-md border-left-0 pl-3" name="contactno" pattern="^\+[0-9]{10,15}$" value="<?= $user['ContactNo'] ?>" readonly>
                    </div>
                    </div>

           ...
           '<div class="col-md-4 col-sm-6 ftco-animate fadeInUp ftco-animated">
            ...
            <form action="roomBooking.php" method= "POST">
               ...
               <div class="text-center p-4">
                   ...
                   <span class="price mb-2"><sup>ETB</sup> <span class="number">'.$row['Cost'].'</span> <sub>/per night</sub></span>
                            ...
                            <div class="card-body pt-0">
                                <div class="widget-49">
                                    ...
                                    <ul class="widget-49-meeting-points">
                                        ...
                                        <li class="widget-49-meeting-item"><span class="font-weight-bold ">Total Cost : '.$row['Amount'].'</span></li>
           ...
           '<div class="col-md-4 col-sm-6 ftco-animate fadeInUp ftco-animated">
            ...
            <form action="eventBooking.php" method= "POST">
               ...
               <div class="text-center p-4">
                   ...
                   <span class="price mb-2"><sup>ETB</sup> <span class="number">'.$row['Cost'].'</span> <sub>/per hour</sub></span>
                   <ul class="pricing-text mb-2">';
                              ...
                              <div class="card-body pt-0">
                                  <div class="widget-49">
                                      ...
                                      <ul class="widget-49-meeting-points">
                                          ...
                                          <li class="widget-49-meeting-item"><span class="font-weight-bold ">Total Cost : </i>'.$row['Amount'].'</span></li>
